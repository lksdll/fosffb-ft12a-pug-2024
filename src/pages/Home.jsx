  ...
  return (
   ...
   <div className='lg:max-w-7xl px-5 md:px-14 lg:px-0  lg:mx-auto '>
    ...
    <div className='flex flex-col justify-center'>
      ...
      <Button onClick={()=>window.location.href = "/infos"} className="select-none p-[10px] md:p-[20px] bg-[#fff]"><span class="material-symbols-outlined p-3 mx-3 rounded-md bg-red-500/50 text-red-800">lightbulb</span>Weitere Infos</Button>
